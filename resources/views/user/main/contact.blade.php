    ...
    <div class="row px-xl-5">
        <div class="col-lg-7 mb-5">
            <div class="contact-form bg-light p-30">
                <div id="success"></div>
                <form href="{{ route('user#storeContactData') }}" method="POST">
                @csrf
                    ...
                    <div class="control-group">
                        ...
                        <small class="d-block text-danger mb-3">{{ $errors->first('subject') }}</small>
                    </div>
                    <div class="control-group">
                        <textarea class="form-control" rows="8" id="message" placeholder="Message" name="message">{{ old('message') }}</textarea>
                        <small class="d-block text-danger mb-3">{{ $errors->first('message') }}</small>
                    </div>
                    <div>
        ...
        <div class="col-lg-5 mb-5">
            ...
            <div class="bg-light p-30 mb-3">
                ...
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>pizahub@info.com</p>
                <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+959 123123123</p>
            </div>
        </div>
    </div>
</div>
